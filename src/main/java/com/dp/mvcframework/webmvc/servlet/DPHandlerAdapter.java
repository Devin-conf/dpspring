 ...
 * @since 1.0.0
 */
public class DPHandlerAdapter {


    public DPModelAndView handler(HttpServletRequest req, HttpServletResponse resp, DPHandlerMappinng handler) throws Exception {
        //保存形参列表
...
//                        paramValues[i] = value;
        ...
        boolean isModelAndView = handler.getMethod().getReturnType() == DPModelAndView.class;
        if (isModelAndView) {
            return (DPModelAndView) result;
        }
        return null;
    }
